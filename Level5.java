        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.button2) {
                    ...
                    if(str.contains("footsteps") || str.contains("Footsteps") || str.contains("FOOTSTEPS") || str.contains("footstep") || str.contains("Footstep") || str.contains("FOOTSTEP")) {
                        if(str.contains("no") == false && str.contains("not") == false && str.contains("isn't") == false && str.contains("cannot") == false) {
                            Intent myIntent = new Intent(Level5.this, Level6.class);
